...
#### AI 对话（常用提问）
![AI 对话](./caogao/ai对话.png)

#### 七问切换
![七问切换](./caogao/七问切换.png)

#### Trace 面板
![Trace](./caogao/trace.png)

#### 导出 PDF
![导出 PDF](./caogao/导出pdf.png)

### 七问框架（完整）
1. 论文试图解决什么问题？这是否是一个新的问题？
2. 有哪些相关研究？如何归类？谁是这一课题在领域内值得关注的研究者（公司）？
3. 论文中提到的解决方案之关键是什么？
4. 论文中的实验是如何设计的？
5. 用于定量评估的数据集是什么？代码有没有开源？
6. 文中的实验及结果有没有很好地支持需要验证的科学假设/提出方案？
7. 这篇论文到底有什么贡献？下一步呢？有什么工作可以继续深入？
