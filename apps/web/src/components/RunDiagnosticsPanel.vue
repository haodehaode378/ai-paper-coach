...
const props = defineProps({
  ...
  emptyTraceMessage: { type: String, default: '等待任务开始。' },
...
<template>
  <section class="console-shell" :class="{ 'console-shell-compact': compact }">
    <div class="console-tabs">
      <span class="console-tab console-tab-active">日志</span>
      <span class="console-tab">Trace</span>
      <span class="console-tab">警告</span>
      <span class="console-tab">错误</span>
    </div>
    ...
    <div class="console-body">
      <div class="console-column">
        <div class="console-title-row">
          <h3>运行日志</h3>
          <span class="console-meta">{{ statuses.length }} 条</span>
        </div>
        <ol class="status-list console-list">
          <li v-for="status in statuses" :key="status">{{ status }}</li>
          <li v-if="!statuses.length" class="console-empty">当前还没有运行日志。</li>
        </ol>
      </div>
      ...
      <div class="console-column console-column-wide">
        <div class="console-title-row">
          <h3>Trace 面板</h3>
          <span class="console-meta">{{ traces.length }} 条</span>
        </div>
